...
public class MainActivity extends AppCompatActivity {
    ...
    // To save the data by using the onPause() method
    @Override
    ...
    // method to retrieve and display the saved data, when the app becomes visible again or just started install the app
    @Override
